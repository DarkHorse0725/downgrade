...
import { KycMerkleTree } from '../target/types/kyc_merkle_tree';
import { Connection, Keypair, PublicKey, Transaction, sendAndConfirmTransaction } from "@solana/web3.js";
import { ConcurrentMerkleTreeAccount, SPL_ACCOUNT_COMPRESSION_PROGRAM_ID, SPL_NOOP_PROGRAM_ID, ValidDepthSizePair, createAllocTreeIx } from "@solana/spl-account-compression";
...
describe("merkle tree", () => {
  ...
  const program = anchor.workspace.KycMerkleTree as Program<KycMerkleTree>
